...
def exe_test(sess, data, batch_size, v2i, i2v, hf1, hf2, feature_shape1, feature_shape2, 
	predict_words, input_video1, input_video2, input_captions, y, capl=16):
...
def main(hf1, hf2,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	attentionCaptionModel = mGRUAstarCaptionModel.mGRUAstarAttentionCaptionModel(input_video1, input_video2, input_captions, voc_size, d_w2v, output_dim, T_k=[1,2,4,8])
	...
	with sess.as_default():
		...
		for epoch in xrange(total_epoch):
			...
			js = exe_test(sess, test_data, batch_size, v2i, i2v, hf1, hf2, feature_shape1, feature_shape2,
										predict_words, input_video1, input_video2, input_captions, y, capl=capl)
...
if __name__ == '__main__':
	...
	f_type = 'astar_sparse_c3d_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
