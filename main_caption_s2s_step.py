...
def exe_train(sess, data, batch_size, v2i, hf, feature_shape, 
	...
	for batch_idx in xrange(num_batch):
		...
		data_v = DataUtil.getBatchStepVideoFeature(batch_caption,hf,feature_shape)
...
if __name__ == '__main__':
	...
	f_type = 'random_step_GoogleNet'
	# feature_path = '/home/xyj/usr/local/data/in5b-'+str(timesteps_v)+'fpv.h5'
	feature_path = '/home/xyj/usr/local/data/YouTube/feature/pool5_7x7_s1-40f.h5'
