...
def exe_train(sess, data, batch_size, v2i, hf, feature_shape, 
	...
	for batch_idx in xrange(500):
		...
		data_v = MsrDataUtil.getBatchStepVideoFeature(batch_caption,hf,feature_shape)
...
if __name__ == '__main__':
	...
	feature_path = '/mnt/data3/yzw/MSRVTT2017/features/googlenet_pl5_f40.h5'
