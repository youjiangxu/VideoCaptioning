...
def exe_train(sess, data, batch_size, v2i, hf, feature_shape, 
	...
	# for batch_idx in xrange(500):
		...
		data_c, data_y = MsrDataUtil.getBatchTrainCaption(batch_caption, v2i, capl=capl)
...
def main(hf,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	# Create vocabulary
	v2i, train_data, val_data, test_data = MsrDataUtil.create_vocabulary_word2vec(file, capl=capl, v2i={'': 0, 'UNK':1,'BOS':2, 'EOS':3}, limit_sen=5)
	...
	attentionCaptionModel = mGRUCaptionModel.mGRUAttentionBeamsearchCaptionModel(input_video, input_captions, voc_size, d_w2v, output_dim, 
		max_len = 16, beamsearch_batchsize = 1, beam_size=4)
...
if __name__ == '__main__':
	...
	f_type = 'beamsearch_mgru_attention_resnet152_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
	...
	pretrained_model = '/home/xyj/usr/local/saved_model/msrvtt2017/s2s_beamsearch_mgru_attention_resnet152_dw2v1024_outputdim1024/lr0.0001_f40_B128/model/E11_L2.88467909625.ckpt'
	
	main(hf,f_type,capl=16, d_w2v=1024, output_dim=1024,
