...
def main(hf1,hf2,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	# Create vocabulary
	v2i, train_data, test_data = MsrFinalDataUtil.create_vocabulary_word2vec(file, capl=capl, word_threshold=1, v2i={'': 0, 'UNK':1,'BOS':2, 'EOS':3}, num_training=9000)
	...
	attentionCaptionModel = mGRUCaptionCategoriesModel.mGRUFinalModel(input_video1, input_video2, input_captions, input_categories, voc_size, d_w2v, output_dim, T_k=[1,2,4,8])
...
if __name__ == '__main__':
	...
	f_type = '9000traindata_categories+resnet+c3dfc7_mgru1248_attention_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
	...
	main(hf1,hf2,f_type,capl=capl, d_w2v=d_w2v, output_dim=output_dim,
		...
		file='/home/xyj/usr/local/data/msrvtt',pretrained_model=pretrained_model, Test=True)
