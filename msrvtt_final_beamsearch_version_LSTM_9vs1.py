...
def main(hf1,hf2,f_type,num_training=None, capl=16, d_w2v=512, output_dim=512,
	...
	attentionCaptionModel = FinalModel.mLSTMFinalBeamsearchCaptionModel(input_video1, input_video2, input_captions, input_categories, voc_size, d_w2v, output_dim, 
...
if __name__ == '__main__':
	...
	f_type = str(num_training)+'training_categories+resnet152+c3dfc7New_mLSTM1248_attention_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
	...
	hf1 = h5py.File(feature_path1,'r')['images']
	hf2 = h5py.File(feature_path2,'r')['images']
	pretrained_model = '/home/xyj/usr/local/saved_model/msrvtt2017/9000training_categories+resnet152+c3dfc7New_mLSTM1248_attention_dw2v512_outputdim512/lr0.0001_f40_B128/model/E1_L2.80951716407.ckpt'
