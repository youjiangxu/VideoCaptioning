...
def exe_test(sess, data, batch_size, v2i, i2v, hf, feature_shape, 
	...
	for batch_idx in xrange(num_batch):
		...
		generated_captions = DataUtil.convertCaptionI2V(batch_caption, tw, i2v)
...
def main(hf,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	attentionCaptionModel = BeamSearchCaptionModel.BeamSearchAttentionCaptionModel(input_video, input_captions, voc_size, d_w2v, output_dim, max_len = capl, beamsearch_batchsize = 1, beam_size=5, done_token=3)
	...
	with sess.as_default():
		...
		for epoch in xrange(total_epoch):
			...
			#save model
			export_path = '/home/xyj/usr/local/saved_model/youtube/s2s'+'_'+f_type+'/'+'lr'+str(lr)+'_f'+str(feature_shape[0])+'_B'+str(batch_size)
...
if __name__ == '__main__':
	...
	# feature_path = '/home/xyj/usr/local/data/pool5_7x7_s1-40f.h5'
	feature_path = '/data/xyj/pool5_7x7_s1-40f.h5'
	...
	pretrained_model = '/home/xyj/usr/local/saved_model/youtube/s2s_attention_GoogleNet/lr0.0001_f40_B64/model/E4_L1.61562607591.ckpt'
	
	main(hf,f_type,capl=12, d_w2v=512, output_dim=512,
		feature_shape=feature_shape,lr=lr,
		batch_size=64,total_epoch=40,
		file='/home/xyj/usr/local/code/VideoCaptioning/data',pretrained_model=pretrained_model)
