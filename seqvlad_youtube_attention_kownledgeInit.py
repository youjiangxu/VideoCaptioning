...
def main(hf,f_type,
	...
	attentionCaptionModel = SeqVladModel.SeqVladKnowledgeInitAttentionModel(input_video, input_captions, voc_size, d_w2v, output_dim,
...
if __name__ == '__main__':
	...
	f_type = 'knowInit_tanh_seqvlad_withoutinit_attention_google_dw2v'+str(d_w2v)+'_out'+str(output_dim)+'_k'+str(kernel_size)+'_c'+str(centers_num)
