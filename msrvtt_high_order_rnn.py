...
def main(hf,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	attentionCaptionModel = MultipleCaptionModel.mGRUFourOrderCaptionModel(input_video, input_captions, voc_size, d_w2v, output_dim, T_k=[1,2,4,8], 
...
if __name__ == '__main__':
	...
	f_type = '4th_order_beamsearch_sparse_mgru_attention_resnet152_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
	...
	main(hf,f_type,capl=20, d_w2v=1024, output_dim=1024,
