...
def main(hf1,hf2,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	attentionCaptionModel = FinalModel.mGRUFinalBi3thStopModel(input_video1, input_video2, input_captions, input_categories, voc_size, d_w2v, output_dim, T_k=[1,2,4,8])
...
if __name__ == '__main__':
	...
	f_type = 'bi+3thstep_categories+resnet+c3dfc7New_mgru1248_attention_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)
	...
	# pretrained_model = '/home/xyj/usr/local/saved_model/msrvtt2017/categories+resnet+places_mgru1248_attention_dw2v512_outputdim512/lr0.0001_f40_B128/model/E2_L4.03631352396.ckpt'
