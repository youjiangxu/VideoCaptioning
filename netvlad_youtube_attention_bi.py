...
if __name__ == '__main__':
	...
	f_type = 'bi_netvlad_withinit_attention_google_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)+'_k'+str(kernel_size)+'_c'+str(centers_num)
	...
	# pretrained_model = '/home/xyj/usr/local/saved_model/youtube/netvlad_withinit_attention_google_dw2v512_outputdim512_k1_c16/lr0.0001_f10_B64/model/E8_L1.94236441787.ckpt'
