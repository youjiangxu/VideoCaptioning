...
def main(hf,f_type,capl=16, d_w2v=512, output_dim=512,
	...
	# Create vocabulary
	v2i, train_data, test_data = MsrFinalDataUtil.create_vocabulary_word2vec(file, capl=capl, word_threshold=1, v2i={'': 0, 'UNK':1,'BOS':2, 'EOS':3})
...
if __name__ == '__main__':
	...
	f_type = '7010traindata_mLSTM1248_attention_resnet152_dw2v'+str(d_w2v)+'_outputdim'+str(output_dim)+'c'+str(capl)
